...
<nav style="height: 40px;">
    ...
    <div class="contain" style="margin-left:0%">
      ...
      <aside>
        <strong>
          ...
          <nav aria-label="breadcrumb" >
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Ấu Trùng Larva Tinh Nghịch</li>
            </ol>
          </nav>
     </strong>
        ...
        <div class="imggg">
         <img src="../images/Larva.png" alt="hh" style="width:250px ;height:400px;margin-left:15px;margin-top:35px;float:left;margin-right:15px;">
        </div>
        <div class="content" >
          <div class="h1">
            <h1  >
            Ấu Trùng Larva Tinh Nghịch
            </h1>
             <h6>
             [Cập nhật lúc: 20:27 18/02/2020]
             </h6>
             <h6>  <i class="fa fa-user fa-lg">Tác giả :Larva</i></h6>
          ...
          Bộ truyện tranh hài hước xoay quanh cuộc sống dưới cống ngầm của 2 chú ấu trùng Vàng và Đỏ cùng những người bạn
 Tính cách của các nhân vật được khắc họa rõ nét
 Là tấm gương phản chiếu một các rõ nhất nhịp thở của cuộc sống hiện đại.<hr>
