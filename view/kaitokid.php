...
<nav style="height: 40px;">
    ...
    <div class="contain" style="margin-left:0%">
      ...
      <aside>
        <strong>
          ...
          <nav aria-label="breadcrumb" >
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">MAGIC KAITO</li>
            </ol>
          </nav>
     </strong>
        ...
        <div class="imggg">
         <img src="../images/kaitokid.png" alt="hh" style="width:250px ;height:400px;margin-left:15px;margin-top:35px;float:left;margin-right:15px;">
        </div>
        <div class="content" >
          <div class="h1">
            <h1  >
            MAGIC KAITO
             ...
             <h6>  <i class="fa fa-user fa-lg">Tác giả :Gosho Aoyama</i></h6>
             <h6>  <i class="fa fa-tags fa-lg">Thể loại:Adventure-Comedy-Manga-Romance-Shounen-Trinh Thám</i></h6>
          ...
          <!-- <h3>Nội Dung</h3> -->
          Là một tội phạm bị cả thế giới truy nã, Kaitõ thực ra chính là một ảo thuật gia đại tài nổi tiếng trên toàn thế giới, Kuroba Tōichi (黒羽 盗一). Tám năm trước khi câu chuyện bắt đầu, Toichi được một băng nhóm tộI phạm thuê (AKA: Tổ chức Áo đen) để tìm và đánh cắp một viên kim cương đặc biệt và có ma lực. Viên kim cương này, có tên là "Pandora Gem" được tiết lộ là có “nước mắt” chứa bên trong, khi soi nó trước ánh trăng, sẽ có ma lực xuất hiện. Sau khi phát hiện ra điều đó Toichi quyết định sẽ không giao lại viên đá đó, anh mang nó trở lại. Băng nhóm thuê anh đã ám sát anh trong một buổi biểu diễn ảo thuật, và bố trí cho cái chết của anh chỉ là một tai nạn.<h6>  <i class="fa fa-list fa-lg">Danh Sách Chương</i></h6>
