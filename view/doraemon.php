...
<nav style="height: 40px;">
    ...
    <div class="contain" style="margin-left:0%">
      ...
      <aside>
        ...
        <div class="imggg">
         <img src="../images/doraemon.png" alt="hh" style="width:250px ;height:400px;margin-left:15px;margin-top:35px;float:left;margin-right:15px;">
        </div>
        <div class="content" >
          <div class="h1">
            <h1  >
            DORAEMON
             ...
             <h6>  <i class="fa fa-user fa-lg">Tác giả :Fujimoto</i></h6>
