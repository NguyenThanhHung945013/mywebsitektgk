...
<nav style=" padding-bottom: 25px;">
        ...
        <strong>
          ...
          <nav aria-label="breadcrumb" >
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page"> Đấu La Đại Lục</li>
            </ol>
          </nav>
     </strong>
        ...
        <div class="content" >
          <div class="h1">
            ...
            Đấu La Đại Lục
             ...
             <h6>  <i class="fa fa-tags fa-lg">Thể loại:Action - Adventure  - Shounen - Supernatural</i></h6>
          ...
          <div>
          <button type="button" class="btn btn-outline-success"><a href="./daularead.php">Đọc Từ Đầu</a></button>
          <button type="button" class="btn btn-outline-success"  styte="text-decoration:none;"><a href="./daularead2.php">Đọc mới Nhất</a></button>
          </div>
  ...
  <div class="row">
    <div class="col">
    <button type="button" class="btn btn-outline-dark  btn-sm"><a href="./daularead.php">Chapter1001</a></button>
    </div>
    <div class="col">
    <button type="button" class="btn btn-outline-dark  btn-sm"><a href="./daularead2.php">Chapter1002</a></button>
    </div>
    <div class="col">
