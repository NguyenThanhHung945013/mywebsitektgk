...
<nav style="height: 40px;">
    ...
    <div class="contain" style="margin-left:0%">
      ...
      <aside>
        ...
        <div class="imggg">
         <img src="../images/pokemon.png" alt="hh" style="width:250px ;height:400px;margin-left:15px;margin-top:35px;float:left;margin-right:15px;">
        </div>
        <div class="content" >
          <div class="h1">
            <h1  >
          ...
          <!-- <h3>Nội Dung</h3> -->
          Bộ truyện nói về một cậu bé tên là Stoshi và nhiều nhà thám hiểm pokemon khắc, là nhưng một nhà huấn luyện pokemon và được giáo sư Oak giao nhiệm vụ hoàn thành bộ Pokemon của mình, trên hành trình của họ gồm có Green, Blue.... và các loài Pokemon khác, đặc biệt là chú Pikachu của cậu ... họ phải đối mắt với nhiều nguy hiểm và vượt qua nhiều, âm mưu của tổ chức bí ẩn.Cái này mình up típ mấy phần mà mấy tên kia chưa có up
