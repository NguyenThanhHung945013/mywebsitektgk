...
<nav style=" padding-bottom: 25px;">
        ...
        <strong>
          ...
          <nav aria-label="breadcrumb" >
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page"> Joker</li>
            </ol>
          </nav>
     </strong>
               
        <div class="imggg">
         <img src="../images/Joker.jpg" alt="hh" style="width:250px ;height:400px;margin-left:15px;margin-top:35px;float:left;margin-right:15px;">
        </div>
        <div class="content" >
          <div class="h1">
            <h1  >
         Joker
             ...
             <h6>  <i class="fa fa-user fa-lg">Tác giả :MAVEL</i></h6>
             <h6>  <i class="fa fa-tags fa-lg">Thể loại:Action - Comedy - Fantasy - Shounen - Supernatural</i></h6>
          ...
          <div>
          <button type="button" class="btn btn-outline-success"><a href="./jokerread.php">Đọc Từ Đầu</a></button>
          <button type="button" class="btn btn-outline-success"  styte="text-decoration:none;"><a href="./jokerread2.php">Đọc mới Nhất</a></button>
          </div>
  ...
  <div class="row">
    <div class="col">
    <button type="button" class="btn btn-outline-dark  btn-sm"><a href="./jokerread.php">Chapter1001</a></button>
    </div>
    <div class="col">
    <button type="button" class="btn btn-outline-dark  btn-sm"><a href="./jokerread2.php">Chapter1002</a></button>
    </div>
    <div class="col">
