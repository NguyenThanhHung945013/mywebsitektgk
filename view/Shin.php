...
<nav style="height: 40px;">
    ...
    <div class="contain" style="margin-left:0%">
      ...
      <aside>
        <strong>
          ...
          <nav aria-label="breadcrumb" >
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">SHIN cậu bé bút chì</li>
            </ol>
          </nav>
     </strong>
        ...
        <div class="imggg">
         <img src="../images/Shin.png" alt="hh" style="width:250px ;height:400px;margin-left:15px;margin-top:35px;float:left;margin-right:15px;">
        </div>
        <div class="content" >
          <div class="h1">
            <h1  >
            CRAYON SHIN-CHAN CẬU BÉ BÚT CHÌ
             ...
             <h6>  <i class="fa fa-user fa-lg">Tác giả :Yoshito Usui</i></h6>
             <h6>  <i class="fa fa-tags fa-lg">Thể loại::Action - Comedy - Slice of Life</i></h6>
          ...
          <!-- <h3>Nội Dung</h3> -->
          Crayon Shinchan xoay quanh những câu chuyện thú vị của một cậu nhóc 5 tuổi tinh quái Nohara Shinnosuke với bố Hiroshi và mẹ Misae cùng những người bạn vô cùng dễ thương ở trường mẫu giáo. Sự "hiểu đời" rất vô tư của nhóc Shin đã gây ra những tình huống dở khóc dở cười cho bao người lớn. Tuy nhiên đằng sau tiếng cười đó là những bài học nhẹ nhàng về cách nuôi dạy con trẻ khiến chúng ta phải suy ngẫm.
Đôi điều tâm sự: với bộ truyện này bọn mình cố gắng mang đến cho các bạn bản dịch chất lượng nhất có thể (dịch từ Jap và edit từ RAW đẹp)
Mong các bạn ủng hộ và đón xem thường xuyên..<h6>  <i class="fa fa-list fa-lg">Danh Sách Chương</i></h6>
