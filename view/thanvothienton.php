...
<nav style=" padding-bottom: 25px;">
        ...
        <strong>
          ...
          <nav aria-label="breadcrumb" >
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Thần võ Thiên Tôn</li>
            </ol>
          </nav>
     </strong>
               
        <div class="imggg">
         <img src="../images/thanvothienton.jpg" alt="hh" style="width:250px ;height:400px;margin-left:15px;margin-top:35px;float:left;margin-right:15px;">
        </div>
        <div class="content" >
          <div class="h1">
            <h1  >
  ...
  <div class="row">
    <div class="col">
    <button type="button" class="btn btn-outline-dark  btn-sm"><a href="./thanvoread.php">Chapter1001</a></button>
    </div>
    <div class="col">
    <button type="button" class="btn btn-outline-dark  btn-sm"><a href="./thanvoread.php">Chapter1002</a></button>
    </div>
    <div class="col">
